                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <input type="text" name="bulan" value="<?php echo $data['bulan']; ?>" disabled="disabled"/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">UBAH BAYAR<i class="fas fa-arrow-right"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>
